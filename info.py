...
BOT_TOKEN = environ.get('BOT_TOKEN', '7847397254:AAFgVo3LsfpaN_k45iICOiG9hL4X-6eFTKk')

DWLD = environ.get("DWLD", 'FHDmovies24x7/5')
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002604116206')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Legion:212002@legion.95ertjl.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'f53eeaa6565d9cfe1b9bfc58e26a280066a371fb')
SECOND_SHORTLINK_URL = environ.get('SECOND_SHORTLINK_URL', 'nowshort.com')
SECOND_SHORTLINK_API = environ.get('SECOND_SHORTLINK_API', 'f53eeaa6565d9cfe1b9bfc58e26a280066a371fb')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/fhdmovies24x7')
TUTORIAL = environ.get('TUTORIAL', 'https://telegram.me/FHDmovies24x7/5')
