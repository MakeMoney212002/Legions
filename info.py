...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", f"{script. IMDB_TEMPLATE_TXT}"📹 <i>» <b> <a href={url}>{title}</a></b> | <b><a href={url}/releaseinfo>{year}</a></b></i> 🎭 <i><b>Genres » {genres}</b></i> 🌟 <i><b>Rating » <a href={url}/ratings>{rating}</a> / 10</b></i> 👑 <i>𝙹𝙾𝙸𝙽 » <b>@FHDmovies24x7</b></i> <i>Select Any File From Below To Download 👇</i>")
